...
crates/sql       -- a constrained SQL subset: lexer/parser -> a small
                     ...
                     Lexer/parser DONE (ticket 003); executor DONE (ticket 004); CLI, workload and measurements DONE (ticket 005). Phase 6 complete. Built bottom-up (ticket 003+), scope narrowed
